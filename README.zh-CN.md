...
+------+------+------+------+------+------+------+------+------+------+------+------+
|  1   |  2   |  3   |  4   |  5   |  6   |  7   |  8   |  9   |  0   |  -   |  +   |
| 隐左 | 隐右 |隐HUD | 1:1  | 50%  | 100% | 200% | 400% | 800% | 减法 | 步退 | 步进 |
+------+------+------+------+------+------+------+------+------+------+------+------+

   +------+------+------+------+------+------+------+------+------+------+
   |  Q   |  W   |  E   |  R   |  T   |  Y   |  U   |  I   |  O   |  P   |
   |      |      | 居中 | 复位 | 纹理 | 减法 | 亮度 | 缩放 |      | 取色 |
   +------+------+------+------+------+------+------+------+------+------+

      +------+------+------+------+------+------+------+------+------+
      |  A   |  S   |  D   |  F   |  G   |  H   |  J   |  K   |  L   |
      |前一帧| 交换 |后一帧| 存图 |      | 帮助 | 减速 |      | 加速 |
      +------+------+------+------+------+------+------+------+------+
...
+----------+----------+------+------+------+------+------+------+
|  Space   |   Tab    |  Up  | Down | Left |Right | PgUp | PgDn |
|播放/暂停 | 切右视频 | +15s | -15s | -1s  | +1s  |+600s |-600s |
+----------+----------+------+------+------+------+------+------+
```
